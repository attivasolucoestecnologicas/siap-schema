...
class Cessao extends Base
{
    public function processar()
    {
        ...
        foreach ($this->dados as $dado) {
            $content = $this->xml->createElement('Cessao');
            ...
            $elements = [
                ...
                $this->xml->createElement('Onus', @$dado['onus']),
                $this->xml->createElement('CNPJCedente', @$dado['cnpj_cedente']),
                $this->xml->createElement('CNPJCessionario', @$dado['cnpj_cessionario']),
            ];
